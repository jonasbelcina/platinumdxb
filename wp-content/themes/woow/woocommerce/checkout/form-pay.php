...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'woow' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'woow' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php
	...
	<div id="payment">
		...
		<h3><?php esc_html_e( 'Payment', 'woow' ); ?></h3>
		...
		<div class="form-row">
			...
			<?php
				$pay_order_button_text = apply_filters( 'woocommerce_pay_order_button_text', esc_html__( 'Pay for order', 'woow' ) );
