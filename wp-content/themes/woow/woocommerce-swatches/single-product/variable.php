...
<form action="<?php echo esc_url($product->add_to_cart_url()); ?>" 
      ...
      data-dh_disable_variation_gallery="<?php echo esc_attr(get_post_meta(get_the_ID(),'_dh_disable_variation_gallery',true)) ?>"
      >
	...
	<div class="product-options icons-lg">
		...
		<div class="clear"></div><a id="variations_clear" href="#reset" style="display:none;"><?php esc_html_e('Reset selection', 'woow'); ?></a>
