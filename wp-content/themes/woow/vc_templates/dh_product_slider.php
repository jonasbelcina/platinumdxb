...
$output .='<div class="caroufredsel product-slider'.(!empty($no_padding) ? ' caroufredsel-item-no-padding':'').$el_class.'" data-scroll-fx="'.$fx.'" data-speed="'.$scroll_speed.'" data-height="variable" data-easing="'.$easing.'" data-visible-min="1" data-scroll-item="'.$scroll_item.'" data-responsive="1" data-infinite="1" data-autoplay="'.(!empty($auto_play)?'1':'0').'">';
