...
class DHWC_Widget_Brands extends WP_Widget {
	...
	public function __construct(){
		$widget_options = array( 'classname' => 'woocommerce dhwc_widget_brands', 'description' => __( 'A list or dropdown of product brands.','sitesao') );
		$control_options = array();
		parent::__construct('dhwc_widget_brands',__('DHWOO Product Brands','sitesao'), $widget_options, $control_options);
	}
	/**
	 * (non-PHPdoc)
	...
	public function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', empty( $instance['title'] ) ? __( 'Product brands', 'sitesao' ) : $instance['title'], $instance, $this->id_base);
		...
		if ( $d ) {
			...
			$brand_args['show_option_none'] 	= __('No product brands exist.', 'sitesao' );
	...
	public function form($instance){
		...
		?>
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Title:', 'sitesao' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" /></p>
		
		<p><label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e( 'Order by:', 'sitesao' ) ?></label>
		<select id="<?php echo esc_attr( $this->get_field_id('orderby') ); ?>" name="<?php echo esc_attr( $this->get_field_name('orderby') ); ?>">
			<option value="order" <?php selected($orderby, 'order'); ?>><?php _e( 'Order', 'sitesao' ); ?></option>
			<option value="name" <?php selected($orderby, 'name'); ?>><?php _e( 'Name', 'sitesao' ); ?></option>
		</select></p>
		...
		<label for="<?php echo $this->get_field_id('dropdown'); ?>"><?php _e( 'Show as dropdown', 'sitesao' ); ?></label><br />

		<input type="checkbox" class="checkbox" id="<?php echo esc_attr( $this->get_field_id('count') ); ?>" name="<?php echo esc_attr( $this->get_field_name('count') ); ?>"<?php checked( $count ); ?> />
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Show post counts', 'sitesao' ); ?></label><br />

		<input type="checkbox" class="checkbox" id="<?php echo esc_attr( $this->get_field_id('hierarchical') ); ?>" name="<?php echo esc_attr( $this->get_field_name('hierarchical') ); ?>"<?php checked( $hierarchical ); ?> />
		<label for="<?php echo $this->get_field_id('hierarchical'); ?>"><?php _e( 'Show hierarchy', 'sitesao' ); ?></label><br/>
		...
		<label for="<?php echo $this->get_field_id('show_children_only'); ?>"><?php _e( 'Only show children for the current brand', 'sitesao' ); ?></label></p>
