...
if (dhwc_is_active() && !class_exists('DHWC_Brand')){
	class DHWC_Brand {
		...
		function dhwc_init_taxonomy(){
			...
			$product_brand_slug = empty( $permalinks['brand_base'] ) ? _x( 'product-brand', 'slug', 'sitesao' ) : $permalinks['brand_base'];
			...
			register_taxonomy ( 'product_brand', 
				...
				apply_filters ( 'dhwc_taxonomy_args_product_brand', array (
					...
					'label' => __ ( 'Product Brands', 'sitesao' ),
					'labels' => array (
							'name' => __ ( 'Product Brands', 'sitesao' ),
							'singular_name' => __ ( 'Product Brand', 'sitesao' ),
							'menu_name' => _x ( 'Brands', 'Admin menu name', 'sitesao' ),
							'search_items' => __ ( 'Search Product Brands', 'sitesao' ),
							'all_items' => __ ( 'All Product Brands', 'sitesao' ),
							'parent_item' => __ ( 'Parent Product Brand', 'sitesao' ),
							'parent_item_colon' => __ ( 'Parent Product Brand:', 'sitesao' ),
							'edit_item' => __ ( 'Edit Product Brand', 'sitesao' ),
							'update_item' => __ ( 'Update Product Brand', 'sitesao' ),
							'add_new_item' => __ ( 'Add New Product Brand', 'sitesao' ),
							'new_item_name' => __ ( 'New Product Brand Name', 'sitesao' ) 
					),
					'show_ui' => true,
		...
		*/
	    ...
	    function dhwc_add_prouduct_brand_meta(){
			...
			if ( is_singular( 'product' ) ) {
				echo apply_filters('dhwc_prouduct_brand_meta',dhwc_get_brands( $post->ID, ', ', ' <span class="posted_in">' . __('Brand:', 'sitesao').' ', '.</span>' ));
			}
	    }
