...
if (dhwc_is_active() && !class_exists('DHWCLookbook')){
	class DHWCLookbook {
		...
		public function register_taxonomy(){
			...
			$product_lookbok_slug = empty( $permalinks['lookbok_base'] ) ? _x( 'product-lookbok', 'slug', 'sitesao' ) : $permalinks['lookbok_base'];
			...
			register_taxonomy ( 'product_lookbook', 
				...
				apply_filters ( 'dhwc_taxonomy_args_product_lookbok', array (
					...
					'label' => __ ( 'Product Lookbooks', 'sitesao' ),
					'labels' => array (
							'name' => __ ( 'Product Lookbooks', 'sitesao' ),
							'singular_name' => __ ( 'Product Lookbook', 'sitesao' ),
							'menu_name' => _x ( 'Lookbooks', 'Admin menu name', 'sitesao' ),
							'search_items' => __ ( 'Search Product Lookbooks', 'sitesao' ),
							'all_items' => __ ( 'All Product Lookbooks', 'sitesao' ),
							'parent_item' => __ ( 'Parent Product Lookbook', 'sitesao' ),
							'parent_item_colon' => __ ( 'Parent Product Lookbook:', 'sitesao' ),
							'edit_item' => __ ( 'Edit Product Lookbook', 'sitesao' ),
							'update_item' => __ ( 'Update Product Lookbook', 'sitesao' ),
							'add_new_item' => __ ( 'Add New Product Lookbook', 'sitesao' ),
							'new_item_name' => __ ( 'New Product Lookbook Name', 'sitesao' ) 
					),
					'show_ui' => true,
