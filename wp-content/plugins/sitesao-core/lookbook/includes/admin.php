...
function  dhlookbook_product_lookbook_description() {
	echo wpautop( __( 'Product lookbooks for your store can be managed here. To change the order of lookbooks on the front-end you can drag and drop to sort them. To see more lookbooks listed click the "screen options" link at the top of the page.', 'sitesao' ) );
}
...
?>
	<div class="form-field">
		<label><?php _e( 'Small title', 'sitesao' ); ?></label>
...
function  dhlookbook_edit_lookbook_thumbnail($term, $taxonomy ){
	...
	?>
	<tr class="form-field">
		<th scope="row" valign="top"><label><?php _e( 'Small title', 'sitesao' ); ?></label></th>
...
function  dhlookbook_permalink_settings_add(){
	add_settings_field(
		...
		__( 'Product lookbook base', 'sitesao' ), 	// setting title
...
function  dhlookbook_product_lookbook_slug_input(){
	$permalinks = get_option( 'woocommerce_permalinks' );
	?>
	<input name="dhlookbook_product_lookbook_slug" type="text" class="regular-text code" value="<?php if ( isset( $permalinks['lookbook_base'] ) ) echo esc_attr( $permalinks['lookbook_base'] ); ?>" placeholder="<?php echo _x('product-lookbook', 'slug', 'sitesao') ?>" />
	<?php
}
