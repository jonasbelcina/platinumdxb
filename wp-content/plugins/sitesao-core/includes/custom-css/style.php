...
<?php if(!empty($custom_colors['header-color'])){ ?>
	@media (min-width: 992px) {
		...
		.navbar-user svg path, .navbar-wishlist svg path, .navbar-search svg path, .navbar-minicart svg path {
...
?>
	...
	.primary-nav > li:not(.megamenu) > .dropdown-menu{
		background-color: <?php echo dh_print_string($navbar_fixed_color)?>;
	}
	<?php endif;?>
	<?php 
...
.footer-featured{
 background-color: <?php echo dh_print_string(darken($custom_colors['footer-bg'],'10%'))?>;
}
<?php endif;?>
...
.footer-copyright a{
	color:<?php echo dh_print_string($custom_colors['footer-link-color'])?>
}
<?php endif;?>
...
.footer-copyright a:hover{
	color:<?php echo dh_print_string($custom_colors['footer-link-hover'])?>
}
<?php endif;?>

<?php if(dh_get_theme_option('button-style','default') == 'radius'):?>
	...
	.woocommerce .shop-loop.list ul.products li.product figcaption .loop-add-to-wishlist .yith-wcwl-add-to-wishlist .add_to_wishlist, 
	.woocommerce .shop-loop.list ul.products li.product figcaption .loop-add-to-wishlist .yith-wcwl-add-to-wishlist .yith-wcwl-wishlistaddedbrowse a, 
	.woocommerce .shop-loop.list ul.products li.product figcaption .loop-add-to-wishlist .yith-wcwl-add-to-wishlist .yith-wcwl-wishlistexistsbrowse a {
...
<?php if(dh_get_theme_option('heading-bg-height','550') && dh_get_theme_option('heading-bg-height','550') != '550'):?>
@media (min-width: 991px) {
	.heading-container .heading-background .heading-wrap{
		 height: <?php echo absint(dh_get_theme_option('heading-bg-height','550'))?>px;
	}
}
<?php endif;?>
